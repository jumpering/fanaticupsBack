...
public class AuthController {
    ...
    public ResponseEntity<JwtTokenResponseDTO> login(
        ...
        // );
        // final UserDetails userDetails = this.userDetailsService.loadUserByUsername(userLoginRequestDTO.getEmail());
    ...
    //      Optional<RegisterReq> optRegisterReq = this.userService.createUser(registerReq);
